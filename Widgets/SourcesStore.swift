...
enum FeedCatalog {
    ...
    static let generalFeeds: [FeedSource] = [
        ...
        .init(id: "cnn_world",
              ...
              kind: .general, icon: "c.square.fill"),
        .init(id: "cnn_top",
              displayName: "CNN — Top Stories",
              url: "http://rss.cnn.com/rss/cnn_topstories.rss",
              kind: .general, icon: "c.square"),
        .init(id: "bbc_world",
              displayName: "BBC — World",
              url: "https://feeds.bbci.co.uk/news/world/rss.xml",
              kind: .general, icon: "globe"),
        .init(id: "nyt_world",
              displayName: "New York Times — World",
              url: "https://rss.nytimes.com/services/xml/rss/nyt/World.xml",
              kind: .general, icon: "n.square.fill"),
        .init(id: "npr_world",
              displayName: "NPR — World",
              url: "https://feeds.npr.org/1004/rss.xml",
              kind: .general, icon: "antenna.radiowaves.left.and.right"),
        .init(id: "aljazeera",
              displayName: "Al Jazeera",
              url: "https://www.aljazeera.com/xml/rss/all.xml",
              kind: .general, icon: "globe.asia.australia.fill"),
        ...
        .init(id: "wapo_world",
              displayName: "Washington Post — World",
              url: "https://feeds.washingtonpost.com/rss/world",
              kind: .general, icon: "w.square.fill"),
    ]
